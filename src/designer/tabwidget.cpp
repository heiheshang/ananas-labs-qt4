...
#include "editor.h"
//
TabWidget::TabWidget(configTreeView *parent)
        : QTabWidget(parent), m_mainImpl( parent )
{
    setMouseTracking( true );
    cross = new QToolButton(this);
    cross->hide();
    cross->setIcon( QIcon(":/images/cross.png") );
...
void TabWidget::tabInserted ( int index )
{
    ...
    //QDomNode moduletext;
    //if( editor )
    //    moduletext = editor->moduletext();
    //tabBar()->setTabToolTip(index,moduletext.parentNode().nodeValue());
}
