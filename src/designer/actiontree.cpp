...
// 
// 
// ActionListViewItem::ActionListViewModel( aCfg * cfgmd,QObject *parent = 0)
// : ananasListViewModel( parent, cfgmd )
// {
...
// 	clearTree();
// 	if ( !md ) return;
// 	setIcon(0,QIcon(rcIcon("actions.png")));
...
// 	gparent->setIcon(0,QIcon(rcIcon("action_g.png")));
...
// 		newitem->setIcon(0,QIcon(rcIcon("action_g.png")));
// 		newitem->edit();
// 	};
// 
// }
...
// {
// 	QMenu *m=new QMenu("PopupMenu");
// 	Q_CHECK_PTR(m);
// 
// 	ContextMenuAdd( m );
// 	//m->insertItem( QObject::tr("New &Group"),  this, SLOT( //itemNewGroup() ), Qt::CTRL+Qt::Key_G );
// 	QAction *newG = m->addAction(QObject::tr("New &Group"));
// 	newG->setShortcut(Qt::CTRL+Qt::Key_G);
// 	connect(newG,SIGNAL(triggered()),SLOT(itemNewGroup()));
// 	//m->insertItem( QObject::tr("New &Action"),  this, SLOT( //itemNewAction() ), Qt::CTRL+Qt::Key_A );
// 	QAction *newR = m->addAction(QObject::tr("New &Action"));
// 	newR->setShortcut(Qt::CTRL+Qt::Key_A);
// 	connect(newG,SIGNAL(triggered()),SLOT(itemNewAction()));
...
// {
// 	ActionListViewItem *i = (ActionListViewItem *) currentItem();
// 	if ( i )
// 		i->newActionGroup();
// };
// 
