...
// extern void set_Icon(QListWidgetItem *item, const char *name);
// 
// InterfaceListViewItem::InterfaceListViewItem( QListWidget *parent, DomCfgItem *cfgobj, const QString &name )
// 
// {
// // 	id = md->id(obj);
...
// };
// 
// InterfaceListViewItem::InterfaceListViewItem( ananasListViewModel *parent, ananasListViewModel *after, DomCfgItem *cfgobj,const QString &name  )
// {
// // 	id = md->id( obj );
// // 	if ( ( id ) && ( md->objClass(obj) != md_separator ) ) setRenameEnabled(0, true);
// // 
...
// 
// void
// InterfaceListViewItem::loadSubmenu ( ananasListViewModel * parent, ananasListViewModel *after, DomCfgItem *child )
// {
...
// 
// void
// InterfaceListViewItem::loadCommand ( ananasListViewModel * parent, ananasListViewModel *after, DomCfgItem *child )
// {
// 	//	new InterfaceListViewItem(  parent, after, md, child, //QString::null );
// };
// 
// void
// InterfaceListViewItem::loadSeparator ( ananasListViewModel * parent, ananasListViewModel *after, DomCfgItem *child )
// {
...
// // // 	popups->loadTree();
// // // 	popups->setOpen ( TRUE );
// // // 	connect( this, SIGNAL( contextMenuRequested( QListWidgetItem*, const QPoint&, int) ), this, SLOT(ContextMenu() ) );
// // // 	connect( this, SIGNAL( returnPressed( QListWidgetItem*) ), this, SLOT( itemEdit() ) );
// // // 	connect( this, SIGNAL( doubleClicked( QListWidgetItem*) ), this, SLOT( itemEdit() ) );
// // };
// // 
// // 
// // void
...
// // {
// // // 	QMenu *m=new QMenu( "PopupMenu",this );
// // // 	Q_CHECK_PTR(m);
// // // 
...
// // // 	m->addAction( tr("&New Submenu"),  this);
// // // 	m->addShortcut(Qt::CTRL+Qt::Key_N);
// // // 	connect(m,SIGNAL(triggered()),SLOT(itemNewSubmenu()));
// // // 	//m->insertItem( tr("New &Command"),  this, SLOT( itemNewCommand() //), Qt::CTRL+Qt::Key_C );
// // // 	m->addAction( tr("New &Command"),  this);
// // // 	m->addShortcut(Qt::CTRL+Qt::Key_N);
// // // 	connect(m,SIGNAL(triggered()),SLOT(itemNewCommand()));
// // // 	//m->insertItem( tr("New &Separator"),  this, SLOT( //itemNewSeparator() ), Qt::CTRL+Qt::Key_S );
// // // 	m->addAction( tr("New &Separator"),  this);
// // // 	m->addShortcut(Qt::CTRL+Qt::Key_S);
// // // 	connect(m,SIGNAL(triggered()),SLOT(itemNewSeparator()));
// // // 	m->exec( QCursor::pos() );
// // // 	delete m;
// // };
// // 
